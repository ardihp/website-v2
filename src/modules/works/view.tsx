...
export default function WorksView() {
  return (
    <DelayedItem>
      <div className="flex flex-col max-w-screen-lg mx-auto w-full pt-[24px]">
        <div className="flex flex-col">
          <div className="grid grid-cols-[1fr_.8fr_1fr] px-[48px]">
            <div className="flex items-center border-x border-style border-secondary/15 w-full p-5">
              <p className="font-fredoka text-2xl font-medium">My Works</p>
            </div>
            <div className="w-full"></div>
            <div className="border-x border-style border-secondary/15 w-full"></div>
          </div>
          <div className="flex w-full">
            <div className="w-full max-w-[48px] border-y border-style border-secondary/15" />
            <div className="flex items-center border border-style border-secondary/15 p-5 w-full">
          ...
          <div className="grid grid-cols-[1fr_.8fr_1fr] px-[48px] h-[36px]">
            <div className="flex gap-4 items-center border-x border-style border-secondary/15 w-full"></div>
            <div className="w-full"></div>
            <div className="border-x border-style border-secondary/15 w-full"></div>
          </div>
        </div>
